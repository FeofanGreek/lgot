...
String monthForCheck = monthIs.format(now); //эталонный номер месяца
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/jurid' :  (context) => PlayWithComputer(),
      },
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void createInterstitialAd() {
    interstitialAd ??= InterstitialAd(
      ...
      listener: AdListener(
        onAdLoaded: (Ad ad) {
          print('${ad.runtimeType} загружено.');
          interstitialReady = true;
        },
        onAdFailedToLoad: (Ad ad, LoadAdError error) {
          print('${ad.runtimeType} ошибка загрузки: $error.');
          ad.dispose();
          interstitialAd = null;
          //createInterstitialAd();
        },
        onAdOpened: (Ad ad) => print('${ad.runtimeType} баннер открыт.'),
        onAdClosed: (Ad ad) {
          print('${ad.runtimeType} баннер закрыт.');
          ad.dispose();
          //createInterstitialAd();
        },
        onApplicationExit: (Ad ad) =>
            print('${ad.runtimeType} из приложения вышли.'),
      ),
    )..load();
                                          ...
                                          child: Stack(
                                            alignment: Alignment.center,
                                              children: <Widget>[
                                                ...
                                                int.parse(monthForCheck) == int.parse(monthIsString) ? Positioned(
                                                        ...
                                                        alignment: Alignment.topLeft,
                                                          ...
                                                          child: Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.57,
                                                                  child: Text('1', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                          )
                                                        )
                                                  ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('2', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('3', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('4', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('5', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('6', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('7', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('8', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('9', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('10', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('11', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('12', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('13', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('14', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('15', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('16', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('17', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('18', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('19', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('20', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('21', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('22', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('23', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('24', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('25', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('26', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('27', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('28', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('29', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('30', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    ...
                                                    child:SizedBox(
                                                        ...
                                                        child: Align(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child:Transform.rotate(
                                                                  angle: -1.5729-angleForLittleCircle*angleCount++,
                                                                  child: Text('31', style: TextStyle(fontSize: 10.0, color: Colors.white,fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
                                                                )
                                                            )
                                                        )
                                                    ),
  ...
  void editPay(int grantId, String monthNum, takeDay)async {
    final DateFormat monthIs = DateFormat('MM');
    String monthIsString = monthIs.format(now);
    final DateFormat dayIs = DateFormat('dd');
    String dayIsString = dayIs.format(now);
    if(int.parse(monthNum) < int.parse(monthIsString) || (int.parse(monthNum) <= int.parse(monthIsString) && takeDay <= int.parse(dayIsString))) {
      try {
        var response = await http.post(
            Uri.parse('https://lgototvet.koldashev.ru/LgotOtvetAPI.php'),
            headers: {"Accept": "application/json"},
            body: jsonEncode(<String, dynamic>{
              "region": "$region",
              "userId": "$userId",
            ...
            return AlertDialog(
              ...
              content: Container(
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        Text(
                            'Дата получения выплаты изменена на $takeDay.$monthNum.$yearNowStringг.'),
          ...
          builder: (context) {
            return AlertDialog(
              title: Text("Благодарим за ответ!",
                ...
                textAlign: TextAlign.center,),
              content: Container(
                  height: push == 0? 120 : 80,
                  child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text('Однако вы не можете указать дату, которая еще не наступила!\n'),
                      ]
                  )),
              actions: <Widget>[
                Container(
  ...
  void yesPay(/*int summTaked,*/ int grantId, String monthNum, takeDay)async{
    ...
    //print('месяц переданый: $monthNum месяц реальный ${int.parse(monthIsString)} $takeDay $dayIsString');
    if(int.parse(monthNum) < int.parse(monthIsString) || (int.parse(monthNum) <= int.parse(monthIsString) && takeDay <= int.parse(dayIsString))) {
print('зачислили');
      try {
        var response = await http.post(
              ...
              content: Container(
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        push == 0
                            ? Text(
                            'Однако вы не можете указать дату, которая еще не наступила!\nРазрешите присылать вам уведомления: мы будем оповещать, когда начнутся выплаты пособий в вашем регионе, и сообщать о положенных льготах.')
                            : Text('Однако вы не можете указать дату, которая еще не наступила!\n'),
                      ]
                  )),
              actions: <Widget>[
